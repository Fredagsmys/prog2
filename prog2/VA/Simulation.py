...
class Simulation:
    ...
    def update(self):
        ...
        for ball in self.balls: # set all update flags to false
            for delbal in todelete:
                if ball.get_obj() == delbal.get_obj():
    ...
    def spawn_obj(self):
        rad = 20
        colors = ['blue', 'red', 'yellow', 'green', 'white', 'gold','blue', 'red', 'yellow', 'green', 'white', 'gold','blue', 'red', 'yellow', 'green', 'white', 'gold','blue', 'red', 'yellow', 'green', 'white', 'gold']
